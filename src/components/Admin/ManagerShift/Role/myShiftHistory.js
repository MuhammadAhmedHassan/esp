...
class MyShiftHistory extends React.Component {
  constructor(props) {
    super(props);
  ...
  submitRequest() {
    this.setState({ loading: true, isEnabled: true }, () => this.getEmployees());
  }
  ...
  render() {
    const {
      loading, employees, fromDate, toDate, selectedYear, pageIndex, pageSize, totalRecords,
          ...
          <Form>
            ...
            <Row>
              ...
              <Col lg={3}>
                ...
                <select className="form-control dropHeight" name="scheduleId" value={scheduleId} onChange={e => this.handleChange(e)}>
                  {
              ...
              <Col lg={3}>
                ...
                <select className="form-control dropHeight" name="shiftId" value={shiftId} onChange={e => this.handleChange(e)}>
                  {
                      shifts.map(shift => (
...
export default (withTranslation()(MyShiftHistory));
