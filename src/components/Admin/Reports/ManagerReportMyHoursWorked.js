...
const { getUser, getFirstLastAndCurrentDateOfTheMonth, getUserId } = userService;

const ManagerReportMyHoursWorked = forwardRef(({
  loading,
  getTimesheet,
...
export default ManagerReportMyHoursWorked;
