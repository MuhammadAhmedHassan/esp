...
const AdminExceptionReport = forwardRef(({
  loading,
  allExceptions,
  getExceptionReport,
  onDownloadFile,
  ...
  const requestBody = (values) => {
    ...
    return {
      ...
      exceptionType: parseInt(values.exceptionType, 10),
    };
  };
      ...
      <Form onSubmit={formik.handleSubmit}>
        ...
        <div className="d-flex align-items-center justify-content-end">
          <Button
            ...
            onClick={() => {
              formik.resetForm();
              // Don't reset table data on filters reset as per the instructions
